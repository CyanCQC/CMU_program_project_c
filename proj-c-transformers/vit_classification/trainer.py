...
class Trainer:
    ...
    def train(self):
        for i in range(self.num_epochs):
            ...
            bar = progressbar.ProgressBar(max_value=len(self.train_dataloader), widgets=[f'ITERATION {i+1} ',  progressbar.Percentage(), ' ', progressbar.Bar(), ' ', progressbar.ETA(),])

            for ii, (images, labels) in enumerate(self.train_dataloader):
                bar.update(ii + 1)
            ...
            # print(f"Iteration {i+1}, loss {epoch_loss/num_batches}")
