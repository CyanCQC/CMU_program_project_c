...
device = 'cuda'
# print(train_dataset.data['word_to_idx'])
# print(train_dataset.data['word_to_idx']["<UNK>"])
# decoder_wti = copy.deepcopy(train_dataset.data["word_to_idx"])
# decoder_itw = copy.deepcopy(train_dataset.data["idx_to_word"])
